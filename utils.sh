...
APP_NAME="${APP_NAME:-KiangGo}"
APP_NAME_LC="$( echo "${APP_NAME}" | awk '{print tolower($0)}' )"
ASSETS_REPOSITORY="${ASSETS_REPOSITORY:-example/kianggo}"
BINARY_NAME="${BINARY_NAME:-kianggo}"
GH_REPO_PATH="${GH_REPO_PATH:-example/kianggo}"
ORG_NAME="${ORG_NAME:-KiangGo}"
