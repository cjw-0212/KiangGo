...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  setpath "product" "nameShort" "KiangGo - Insiders"
  setpath "product" "nameLong" "KiangGo - Insiders"
  setpath "product" "applicationName" "kianggo-insiders"
  setpath "product" "dataFolderName" ".kianggo-insiders"
  setpath "product" "linuxIconName" "kianggo-insiders"
  setpath "product" "quality" "insider"
  setpath "product" "urlProtocol" "kianggo-insiders"
  setpath "product" "serverApplicationName" "kianggo-server-insiders"
  setpath "product" "serverDataFolderName" ".kianggo-server-insiders"
  setpath "product" "darwinBundleIdentifier" "com.kianggo.KiangGoInsiders"
  setpath "product" "win32AppUserModelId" "KiangGo.KiangGoInsiders"
  setpath "product" "win32DirName" "KiangGo Insiders"
  setpath "product" "win32MutexName" "kianggoinsiders"
  setpath "product" "win32NameVersion" "KiangGo Insiders"
  setpath "product" "win32RegValueName" "KiangGoInsiders"
  setpath "product" "win32ShellNameShort" "KiangGo Insiders"
  ...
  setpath "product" "tunnelApplicationName" "kianggo-insiders-tunnel"
  setpath "product" "win32TunnelServiceMutex" "kianggoinsiders-tunnelservice"
  setpath "product" "win32TunnelMutex" "kianggoinsiders-tunnel"
