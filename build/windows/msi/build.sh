...
if [[ "${VSCODE_QUALITY}" == "insider" ]]; then
  PRODUCT_NAME="KiangGo - Insiders"
  PRODUCT_CODE="KiangGoInsiders"
  PRODUCT_UPGRADE_CODE="A1B27082-9D9B-4DB2-B381-1517A9E7FE32"
  ICON_DIR="..\\..\\..\\src\\insider\\resources\\win32"
  SETUP_RESOURCES_DIR=".\\resources\\insider"
else
  PRODUCT_NAME="KiangGo"
  PRODUCT_CODE="KiangGo"
  PRODUCT_UPGRADE_CODE="A1B27082-9D9B-4DB2-B381-1517A9E7FE32"
...
if [[ -z "${1}" ]]; then
	OUTPUT_BASE_FILENAME="KiangGo-${VSCODE_ARCH}-${RELEASE_VERSION}"
else
	OUTPUT_BASE_FILENAME="KiangGo-${VSCODE_ARCH}-${1}-${RELEASE_VERSION}"
fi
